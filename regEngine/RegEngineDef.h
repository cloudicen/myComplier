...
namespace regEngine {
    ...
    /* ---------------------------关键字定义------------------------------- */
    static std::unordered_set<char> keptChar{'|', '*', '(', ')', '\\'};// 保留符号
    static std::unordered_map<char, std::string> keptCharCharDef{
            {'|', "alternate"},
            {'*', "closure"}
    };
    static std::unordered_set<char> escapeChar{'w', 'a', 'd', 's'};//转义符号
